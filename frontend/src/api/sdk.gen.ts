...
import type { AuthControllerMeData, AuthControllerMeResponses, TodoControllerGetAllData, TodoControllerGetAllResponses, TodoControllerAddTodoData, TodoControllerAddTodoResponses, TodoControllerAddTodoErrors, TodoControllerCompleteTodoData, TodoControllerCompleteTodoResponses, TodoControllerCompleteTodoErrors, TodoControllerUncompleteTodoData, TodoControllerUncompleteTodoResponses, TodoControllerUncompleteTodoErrors, TodoControllerModifyTitleData, TodoControllerModifyTitleResponses, TodoControllerModifyTitleErrors, TodoControllerDeleteTodoData, TodoControllerDeleteTodoResponses, TodoControllerDeleteTodoErrors, TodoSseControllerStreamData, TodoSseControllerStreamResponses, TodoSseControllerSubscribeData, TodoSseControllerSubscribeResponses } from './types.gen';
...
/**
 * Return the application principal for the OIDC subject
 */
...
export const todoSseControllerSubscribe = <ThrowOnError extends boolean = false>(options: Options<TodoSseControllerSubscribeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TodoSseControllerSubscribeResponses, unknown, ThrowOnError>({
